module SerieBot
    module Commands
        ...
        command(:facts) do |event|
            facts = ["The blue light on the Wii when you receive a message is meant to be timed exactly with a certain bird call - the Japanese bush warbler. Source: https://www.wired.com/2008/02/nintendos-takas/", "While development of the Forecast Channel took place a thunderstorm hit Nintendo of America and Nintendo of Japan lost contact with them for a while. Source: http://rc24.xyz/story_forecast.php", "During the final stage of News Channel development, a rainstorm hit Nintendo of Europe and Nintendo of Japan lost contact with them. Source: http://rc24.xyz/story_forecast.php", "There's a clock in the News Channel and Forecast Channel in the Europe and Japan versions of the Channel in the top-left corner, but not in the American version.", "The list of cities that appear in the Forecast Channel vary by country, each country has more regional cities to choose from.", "While your Wii's in standby mode and the blue light's glowing, you can turn the light off by pressing the RESET button on your Wii. Source: iDroid", "The Japanese version of the Forecast Channel looks very different than the Europe and American versions of the Channel. There's differences like precipitation shown, a 7-day forecast instead of a 5-day forecast, and a pollen count and a laundry index (which shows if it's appropriate to dry your clothes outside).", "The Photo Channel cat and the News Channel cat are brothers and sisters. Source: http://rc24.xyz/story_photo.php", "The developers of the Photo Channel named the two cats that appear in the Photo Channel and News Channel. The one in the News Channel is named Runda and is male, and the one in the Photo Channel is named Rassie and is female. They both are named that way because of the ways they end their sentences in Japanese. Source: http://rc24.xyz/story_photo.php", "The Photo Channel and News Channel cats were made because one of the developers used a bunch of pictures of cats during development of the Photo Channel (he was a cat lover). So when they decided how to display the tips in the Channels, they decided they should use a cat. http://rc24.xyz/story_photo.php"]
