module SerieBot
  module Help
    ...
    command(:help) do |event|
      ...
      extra_help = ''
      if Helper.has_role?(event, %i[owner dev mod])
        extra_help << "\n\n**Mod commands**\n"
      ...
      if Helper.has_role?(event, %i[owner dev bot])
        extra_help << "\n\n**Developers:**\n"
      ...
      if Helper.has_role?(event, %i[owner bot])
        extra_help << "\n\n**Admins**\n"
      ...
      begin
        event.user.pm(help)
        event.user.pm(extra_help) if Helper.has_role?(event, %i[owner dev bot])
